      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-500 font-medium">Warehouse WH-01 Storage Racks</span>
          </div>
          <h1 className="mt-1 text-xl sm:text-2xl font-black tracking-tight text-slate-900">
            Warehouse Grid & Bin Topology
          </h1>
          <p className="text-xs text-slate-500 mt-0.5">
            Click any storage cell to inspect stored SKUs, real-time occupancy, or commission new storage aisles.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-emerald-600 px-3.5 py-2 text-xs font-bold text-white hover:bg-emerald-500 disabled:opacity-50 transition-all shadow-xs"
          >
            <Plus className="h-4 w-4" />
            {isAddingRow ? 'Commissioning Aisle...' : 'Commission New Aisle / Row'}
          </button>
        </div>
      </div>
